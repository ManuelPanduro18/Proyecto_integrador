...
import com.manuel.tecsup.productosapi.services.HistoriaService;
...
private static final Logger logger = LoggerFactory.getLogger(HelloController.class);
	...
	public List<Historia>historias(){
		logger.info("call historias");
		
		List<Historia>historias=historiaService.listar();
		
		return historias;
	}
	
	@GetMapping("/historias/imagenes/{filename:.+}")
