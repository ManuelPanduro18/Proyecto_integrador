...
import com.manuel.tecsup.productosapi.services.LiteraturaService;
...
public class LiteraturaController {
	...
	@GetMapping("/literaturas")
	public List<Literatura>literaturas(){
		logger.info("call literaturas");
		
		List<Literatura> literaturas=literaturaService.listar();
		
		return literaturas;
	}
	
	@GetMapping("/literaturas/imagenes/{filename:.+}")
