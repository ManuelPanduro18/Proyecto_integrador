...
import com.manuel.tecsup.productosapi.services.NoticiaService;
...
public class NoticiaController {
	...
	@GetMapping("/noticias/imagenes/{filename:.+}")
	public ResponseEntity<Resource>files(@PathVariable String filename)throws Exception{
		...
		return ResponseEntity.ok()
				...
				.header(HttpHeaders.CONTENT_TYPE,
						Files.probeContentType(Paths.get(FILEPATH).resolve(filename)))
